...
title = input('Введите заголовок заметки 1: ')#заголовок заметки
print('Заметка1: ', title)
title = input('Введите заголовок заметки 2: ')
print('Заметка2: ', title)
title = input('Введите заголовок заметки 3: ')
print('Заметка3: ', title)
